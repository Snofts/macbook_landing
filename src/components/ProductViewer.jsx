...
import ModelSwithcers from './three/ModelSwithcers.jsx'
  ...
  return (
    <section id='product-viewer'>
        ...
        <div className='controls'>
            <p className='info'>MacBook pro | Available in 14" & 16" in Space Grey and Dark</p>
        ...
        <Canvas id="canvas" camera={{position: [0, 2, 5], fov: 50, near: 0.1, far: 100 }}>
            ...
            <ModelSwithcers scale={isMobile ? scale - 0.03 : scale} isMobile={isMobile} />
        </Canvas>
    </section>
  )
}
